...
var lyr_IDEAndalucaMapaTopogrficodeAndaluca110000rsterAo2013_1 = new ol.layer.Tile({
                            source: new ol.source.TileWMS(({
                              url: "http://www.ideandalucia.es/wms/mta10r_2001-2013",
                              attributions: ' ',
                              params: {
                                "LAYERS": "distribucion_topograficos_2001-2013",
                                "TILED": "true",
                                "VERSION": "1.3.0"},
                            })),
              ...
              wms_layers.push([lyr_IDEAndalucaMapaTopogrficodeAndaluca110000rsterAo2013_1, 0]);
...
lyr_CartografadelIGN_0.setVisible(true);lyr_IDEAndalucaMapaTopogrficodeAndaluca110000rsterAo2013_1.setVisible(true);lyr_Ortoimagen_2.setVisible(true);lyr_TrminomunicipalLosGallardos_3.setVisible(true);lyr_CaminosmunicipalesLosGallardos_4.setVisible(true);
var layersList = [lyr_CartografadelIGN_0,lyr_IDEAndalucaMapaTopogrficodeAndaluca110000rsterAo2013_1,lyr_Ortoimagen_2,lyr_TrminomunicipalLosGallardos_3,lyr_CaminosmunicipalesLosGallardos_4];
...
lyr_CaminosmunicipalesLosGallardos_4.set('fieldLabels', {'fid': 'hidden field', 'MAPA': 'hidden field', 'DELEGACIO': 'hidden field', 'MUNICIPIO': 'hidden field', 'MASA': 'hidden field', 'HOJA': 'hidden field', 'TIPO': 'hidden field', 'PARCELA': 'hidden field', 'COORX': 'inline label - visible with data', 'COORY': 'inline label - visible with data', 'VIA': 'hidden field', 'NUMERO': 'hidden field', 'NUMERODUP': 'hidden field', 'NUMSYMBOL': 'hidden field', 'AREA': 'hidden field', 'FECHAALTA': 'hidden field', 'FECHABAJA': 'hidden field', 'NINTERNO': 'hidden field', 'PCAT1': 'hidden field', 'PCAT2': 'hidden field', 'EJERCICIO': 'hidden field', 'NUM_EXP': 'hidden field', 'CONTROL': 'hidden field', 'Referencia catastral': 'inline label - visible with data', 'Longitud': 'hidden field', 'AREA.': 'hidden field', 'Ancho': 'hidden field', 'Perímetro (m)': 'inline label - visible with data', 'Coordenada': 'hidden field', 'Coordena_1': 'hidden field', 'Coordena_2': 'hidden field', 'Coordena_3': 'hidden field', 'Orden de inventario': 'inline label - visible with data', 'Nombre': 'inline label - visible with data', 'Veredas': 'inline label - visible with data', });
